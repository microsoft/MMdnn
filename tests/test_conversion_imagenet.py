...
class TestModels(CorrectnessTest):
    ...
    test_table = {
        ...
        'pytorch' : {
            'alexnet'     : [CoreMLEmit, KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'densenet121' : [CoreMLEmit, KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'densenet169' : [CoreMLEmit, KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'densenet161' : [CoreMLEmit, KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'densenet201' : [CoreMLEmit, KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'inception_v3': [CoreMLEmit, KerasEmit, PytorchEmit, TensorflowEmit],  # Mxnet broken https://github.com/apache/incubator-mxnet/issues/10194
            'vgg11'       : [CoreMLEmit, KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'vgg13'       : [CoreMLEmit, KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'vgg16'       : [CoreMLEmit, KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'vgg19'       : [CoreMLEmit, KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'vgg11_bn'    : [CoreMLEmit, KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'vgg13_bn'    : [CoreMLEmit, KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'vgg16_bn'    : [CoreMLEmit, KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'vgg19_bn'    : [CoreMLEmit, KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'resnet18'    : [CoreMLEmit, KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'resnet34'    : [CoreMLEmit, KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            ...
            'resnet152'   : [CoreMLEmit, KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
        }
