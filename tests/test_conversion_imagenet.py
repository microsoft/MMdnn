...
class TestModels(CorrectnessTest):
    ...
    test_table = {
        ...
        'pytorch' : {
            'alexnet'     : [KerasEmit, PytorchEmit, TensorflowEmit],
            'densenet121' : [KerasEmit, PytorchEmit, TensorflowEmit],
            'densenet169' : [KerasEmit, PytorchEmit, TensorflowEmit],
            'densenet161' : [KerasEmit, PytorchEmit, TensorflowEmit],
            'densenet201' : [KerasEmit, PytorchEmit, TensorflowEmit],
            'inception_v3': [KerasEmit, PytorchEmit, TensorflowEmit],
            'vgg11'       : [KerasEmit, PytorchEmit, TensorflowEmit],
            'vgg13'       : [KerasEmit, PytorchEmit, TensorflowEmit],
            'vgg16'       : [KerasEmit, PytorchEmit, TensorflowEmit],
            'vgg19'       : [KerasEmit, PytorchEmit, TensorflowEmit],
            'vgg11_bn'    : [KerasEmit, PytorchEmit, TensorflowEmit],
            'vgg13_bn'    : [KerasEmit, PytorchEmit, TensorflowEmit],
            'vgg16_bn'    : [KerasEmit, PytorchEmit, TensorflowEmit],
            'vgg19_bn'    : [KerasEmit, PytorchEmit, TensorflowEmit],
            'resnet18'    : [KerasEmit, PytorchEmit, TensorflowEmit],
            'resnet34'    : [KerasEmit, PytorchEmit, TensorflowEmit],
            'resnet50'    : [KerasEmit, PytorchEmit, TensorflowEmit],
            'resnet101'   : [KerasEmit, PytorchEmit, TensorflowEmit],
            'resnet152'   : [KerasEmit, PytorchEmit, TensorflowEmit],
        }
