...
class TestModels(CorrectnessTest):
    ...
    test_table = {
        ...
        'pytorch' : {
            'alexnet'     : [KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'densenet121' : [KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'densenet169' : [KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'densenet161' : [KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'densenet201' : [KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'inception_v3': [KerasEmit, PytorchEmit, TensorflowEmit],  # Mxnet broken https://github.com/apache/incubator-mxnet/issues/10194
            'vgg11'       : [KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'vgg13'       : [KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'vgg16'       : [KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'vgg19'       : [KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'vgg11_bn'    : [KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'vgg13_bn'    : [KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'vgg16_bn'    : [KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'vgg19_bn'    : [KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'resnet18'    : [KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'resnet34'    : [KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'resnet50'    : [KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'resnet101'   : [KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            'resnet152'   : [KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
        }
