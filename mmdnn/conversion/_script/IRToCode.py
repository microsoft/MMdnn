...
def _main():
    ...
    # args = argparse.Namespace(IRModelPath='C:\\Users\\15501\\Documents\\GitHub\\MMdnn\\reditt.pb', IRWeightPath='C:\\Users\\15501\\Documents\\GitHub\\MMdnn\\reditt.npy', dstFramework='mxnet', dstModelPath='mxnet_reddit.py', dstWeightPath='mxnet_reddit.npy', phase='test')
    ret = _convert(args)
